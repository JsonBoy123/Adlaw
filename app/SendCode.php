...
class SendCode 
{
	public static function sendCode($phone)
	{
        ...
        $number = (int)$phone;
        $sender = "TESTID";
        $message = urlencode('Verify Code: '.$code);
        ...
        $url = "http://login.yourbulksms.com/api/sendhttp.php?authkey=11456AxEiTIeN5ca87c66&mobiles=".$number."&message=".$message."&sender=ADLAWS&route=4";
