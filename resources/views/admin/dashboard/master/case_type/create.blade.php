						...
						<form action="{{route('case_type.store')}}" method="post">
								...
								<div class="col-md-6">
									...
									<select class="form-control" name="court_type" id="court_type">
										...
										@foreach($court_types as $court_type)
											<option value="{{$court_type->court_type}} " {{'2' == $court_type->court_type ? 'selected' : '' }}>{{$court_type->court_type_desc}}</option>
										@endforeach 
									</select>
									@error('court_type')
							...
							<!-- <div class="row form-group"> -->
								...
								<div class="col-md-6">
									...
									<input type="text" name="shrt_desc" class="form-control" placeholder="Enter Case Short Name">
									@error('shrt_desc')
										<span class="text-danger">
											<strong>{{$message}}</strong>
										</span>
