						...
						<form action="{{route('case_type.update',['id'=>$case_type->case_type_id])}}" method="post">
							...
							<div class="row form-group"> --}}
								<div class="col-md-6">
									...
									<input type="text" name="case_type_desc" class="form-control" placeholder="Enter Case Type Name" value="{{$case_type->case_type_desc}}" >
								...
								<div class="col-md-6">
									<label> Case Short Name <span class="text-danger">*</span></label>
									<input type="text" name="shrt_desc" class="form-control" placeholder="Enter Case short name" value="{{$case_type->shrt_desc}}" >
									@error('shrt_desc')
										<span class="text-danger">
											<strong>{{$message}}</strong>
										</span>
