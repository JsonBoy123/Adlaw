...
<!-- <div align="left" style="font-size:12px;"><font color=#bb0000 face="Verdana, Arial, Helvetica, sans-serif"><b>Causelist for Lawyer Name like <u>Akash Rathi</u> dated <u>25-09-2020</u></b></font></div>
      ...
      <thead>
         <tr  align="left">
            <th colspan="5" height="25px"><br>
            	<b style="color:#bb0000;"><i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Causelist for Lawyer Name like <u>{{$cause_list->lawyer_name !=null ? $cause_list->lawyer_name->name : $cause_list->licence_no}}</u> dated <u>{{$cause_list->hearing_date}}</u></b></i><br>
