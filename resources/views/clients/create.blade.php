			...
			<div class="box-body">
				...
				<div class="row form-group">
					<div class="col-md-6" style="margin-top:10px;">
						...
						<input type="text" value="{{old('mobile1')}}" class="form-control " name="mobile1" placeholder="Mobile Number"  oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');">
						@error('mobile1')
							<span class="invalid-feedback text-danger" role="alert">
							<strong>{{ $message }}</strong>
							</span>
					...
					<div class="col-md-6" style="margin-top:10px;">
						...
						<input type="text" value="{{old('mobile2')}}" class="form-control " name="mobile2" placeholder="Alternate Mobile Number"  oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');">
						@error('mobile2')
							<span class="invalid-feedback text-danger" role="alert">
							<strong>{{ $message }}</strong>
							</span>
				...
				<div class="row form-group">
					...
					<div class="col-md-6" style="margin-top:10px;">
						...
						<input type="text" value="{{old('zip_code')}}" class="form-control " name="zip_code" placeholder="Zip Code"  oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');">						
