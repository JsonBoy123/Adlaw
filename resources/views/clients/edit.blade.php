				...
				@csrf
					...
					<div class="row form-group">
						...
						<div class="col-md-6" style="margin-top:10px;">
							...
							<input type="text" value="{{old('zip_code') ?? $client->zip_code}}" class="form-control " name="zip_code" placeholder="Zip Code"  oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');">						
